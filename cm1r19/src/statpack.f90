...
!-----------------------------------------------------------------------
      ...
      integer :: i,j,k,n,nstat,nloop,nkm
...
121       format(a3)
    ...
    if( stat_kh.eq.1 .or. stat_km.eq.1 )then
        call maxmin(ni,nj,nk+1,xkzh,nstat,rstat,'XKZHMX','XKZHMN')
        call maxmin(ni,nj,nk+1,xkzq,nstat,rstat,'XKZQMX','XKZQMN')
        call maxmin(ni,nj,nk+1,xkzm,nstat,rstat,'XKZMMX','XKZMMN')
    endif
    endif
